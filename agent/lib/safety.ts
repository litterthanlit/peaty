...
const BLOCK_REDIRECT =
  "This is clinician territory. Peaty will not sketch doses, stacks, or DIY protocols for thyroid hormone, aspirin, cyproheptadine, sex hormones (including progesterone), peptides (including BPC-157, TB-4/TB-500, GHK-Cu, and oral Vilon), AAS/Anavar or similar oral steroids, bromantane, or dopamine/prolactin stacks. No stack coaching. Take it to a licensed clinician who can see labs and history. We can keep working on food, warmth, rest, salt/minerals, and the markers you chose.";
