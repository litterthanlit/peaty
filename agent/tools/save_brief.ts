...
export default defineTool({
  ...
  async execute({ primaryGoal, markers, hardConstraints, doNotDo }, ctx) {
    ...
    return {
      ...
      reminder:
        "Safety-gate is ON and cannot be turned off. Dairy or fruit refusals are hard constraints, not Peat defaults. No DIY T3, topical or oral aspirin, topical aspirin/T3 hair, cyproheptadine, progesterone/pregnenolone/hormones, GHK-Cu, GHK-Cu + melanotan-1 topical, oral or injected BPC, BPC-157 hair/angiogenesis, TB-4/TB-500/Vilon, peptide stacks, AAS/Anavar, bromantane, or FarvingCo BPC+lactoferrin+mastic / antimicrobial gut-kill stacks.",
    };
  },
});
