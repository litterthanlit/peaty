...
export default defineTool({
  ...
  async execute({ primaryGoal, markers, hardConstraints, doNotDo }, ctx) {
    ...
    return {
      ...
      reminder:
        "Safety-gate is ON and cannot be turned off. Dairy or fruit refusals are hard constraints, not Peat defaults. No DIY T3, topical or oral aspirin, GHK-Cu, oral or injected BPC, hormones, AAS, bromantane, cypro, or antimicrobial gut-kill stacks.",
    };
  },
});
