...
export default defineTool({
  ...
  async execute({ primaryGoal, markers, hardConstraints, doNotDo }, ctx) {
    ...
    return {
      ...
      reminder:
        "Safety-gate is ON and cannot be turned off. Dairy or fruit refusals are hard constraints, not Peat defaults. No DIY T3, topical or oral aspirin, topical aspirin/T3 hair, cyproheptadine, progesterone/pregnenolone/hormones, oral TRT/DHT, GHK-Cu, melanotan, oral or injected BPC, TB-4/TB-500/Vilon, Khavinson-wave bioregulators, phenibut, peptide stacks, AAS/Anavar, bromantane, or antimicrobial gut-kill stacks.",
    };
  },
});
