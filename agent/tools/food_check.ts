...
export default defineTool({
  description:
    "Score a food or meal against Peaty defaults (raise burn, dairy+fruit sugars, low PUFA, warm/room-temp fluids, glycine from gelatin/stocks/cartilage) and the user's hard constraints. Dairy and fruit are allowed unless the user listed them as constraints. Label berberine/PCOS max stacks as community, not Peat-primary. Carnivore fruit/dairy refusal diverges from Peat.",
