...
6. Safety-gate is non-skippable. DIY T3/T4/NDT, aspirin protocols, cyproheptadine, hormones/pregnenolone, BPC/peptides, bromantane, and dopamine/prolactin stacks are refused in code before other skills act. Redirect to a clinician. Keep the conversation on food and rhythm. Never echo community milligram or mcg figures (FarvingCo-style bromantane, AbudBakri-style T3 or pregnenolone RTs, oxidativestate-style gut-pharma threads).
