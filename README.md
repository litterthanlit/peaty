...
| `fluid-lymph` | Salt, minerals, warmth, walks, sauna-adjacent comfort. Mineralized salted water + eat-your-hydration. Not water restriction, spa detox, cold plunge, or ice biohacks. SolBrah/BioavailableNd are source-digest labels only. |
| `food-check` | Score meals. Dairy/fruit refusals are **hard constraints**, not Peat defaults. Prefer warm/room-temp fluids; glycine via gelatin/collagen/stocks/cartilage. Whitelist Peat-style ice cream (milk/eggs/sugar/coconut, not seed-oil junk) plus pomegranate/pom juice and raw carrot. Collagen/gelatin overlap OK. Berberine/PCOS max stacks are community, not Peat-primary. Carnivore fruit/dairy refusal and Alpaca/Saladino (including herbs-only / steak-centric) diverge from Peat even when carrots/carbs overlap. |
...
| `safety-gate` | Refuse DIY T3 self-dosing, topical or oral aspirin, GHK-Cu, oral or injected BPC, TB-4/TB-500/Vilon, AAS/Anavar and similar oral steroids, hormones/progesterone, bromantane, cypro, dopamine/prolactin stacks, peptide stacks, and FarvingCo-style H. pylori mastic+lactoferrin kill stacks; send that to a clinician. Never echo community doses (oxidativestate, AbudBakri, FarvingCo). |
