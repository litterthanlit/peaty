...
| `metabolism-function` | Metabolic function, not a cut. Don't skip breakfast; morning digestible carbs. Dairy/fruit sugar oxidation. Abud ALAN/leptin–POMC is light color only. Natural Mg is food/mineral with mineralized fluids, not a dose. Not low-carb+ashwagandha as a gut fix. Niacinamide is an optional community food note, not a protocol. |
| `fluid-lymph` | Salt, minerals, warmth, walks, sauna-adjacent comfort. Mineralized salted water + eat-your-hydration. Beef gelatin/glycine mucus-barrier + mineralized fluids. BioavailableNd brine/salt-air is minerals+energy, not spa-lymph. Not water restriction, spa detox, cold plunge, or ice biohacks. SolBrah/BioavailableNd are source-digest labels only. |
| `food-check` | Score meals. Dairy/fruit refusals are **hard constraints**, not Peat defaults. Prefer warm/room-temp fluids; glycine via gelatin/collagen/stocks/cartilage. Whitelist Peat-style ice cream (milk/eggs/sugar/coconut, not seed-oil junk) plus pomegranate/pom juice and raw carrot. BioavailableNd-style fall stack (pom juice/tea, meat stock, warm milk+honey+glycine) when ingredients fit. Collagen/gelatin overlap OK. OJ intolerance is person/context, not "juice is poison" (not a diagnosis). SolBrah salted egg-white sugar meringue and natural/liquid Mg are optional community food notes. Fish-oil megadoses, ashwagandha, berberine/PCOS max, and processed junk are community/poor-fit, not Peat-primary. Always flag Alpaca/Saladino carnivore vs same-day dairy+fruit (including herbs-only / steak-centric) even when carrots/carbs overlap. |
| `source-digest` | Week recap from logs, or a pasted Peat source → practical move. Community handles are labels, not medical claims. Always flag Alpaca carnivore split vs same-day dairy+fruit. |
| `safety-gate` | Refuse DIY T3 self-dosing, topical or oral aspirin, topical aspirin/T3 hair, GHK-Cu, melanotan, BPC all routes (including oral BPC pill/shop CTAs), TB-4/TB-500/Vilon, GLP-1s, thymus peptides, bioregulators, phenibut, AAS/Anavar and similar oral steroids, hormones/progesterone/pregnenolone, oral TRT/DHT, bromantane, cypro, dopamine/prolactin stacks, peptide stacks, and FarvingCo-style H. pylori mastic+lactoferrin kill stacks; send that to a clinician. Never echo community doses (oxidativestate, AbudBakri/Julian Dorey, FarvingCo). yoursimmo11 anti-TRT-first is community TRT-first skepticism, not a protocol. |
