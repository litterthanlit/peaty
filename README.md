...
| `metabolism-function` | Metabolic function, not a cut. Don't skip breakfast; morning digestible carbs. Dairy/fruit sugar oxidation (OJ / honey / maple when the rest of the meal is solid). Push back fructose fear (community ≠ Peat). Not low-carb+ashwagandha as a gut fix. Niacinamide is an optional community food note, not a protocol. |
...
| `food-check` | Score meals. Dairy/fruit refusals are **hard constraints**, not Peat defaults. Prefer warm/room-temp fluids; glycine via gelatin/collagen/stocks/cartilage. Whitelist Peat-style ice cream (milk/eggs/sugar/coconut, not seed-oil junk) plus OJ / fruit sugars / honey / maple, pomegranate/pom juice, and raw carrot when the rest of the meal is solid. Push back fructose fear (iso-caloric community fear ≠ Peat). Collagen/gelatin overlap OK. Fish-oil megadoses, ashwagandha, berberine/PCOS max, and processed junk are community/poor-fit, not Peat-primary. Always flag Alpaca/Saladino carnivore fruit/dairy split (including herbs-only / steak-centric and carbs-are-back) even when carrots/carbs/fruit overlap. AbudBakri OJ and Alpaca carbs-are-back are community/source-digest labels only. |
...
| `safety-gate` | Refuse DIY T3 self-dosing, topical or oral aspirin, topical aspirin/T3 hair, GHK-Cu, GHK-Cu + melanotan-1 topical stacks, oral or injected BPC, BPC-157 hair/angiogenesis, TB-4/TB-500/Vilon, AAS/Anavar and similar oral steroids, hormones/progesterone/pregnenolone, bromantane, cypro, dopamine/prolactin stacks, peptide stacks, FarvingCo-style H. pylori mastic+lactoferrin kill stacks, and FarvingCo BPC+lactoferrin+mastic gut stacks; send that to a clinician. Never echo community doses (oxidativestate, anabology RT, FarvingCo, AbudBakri). |
